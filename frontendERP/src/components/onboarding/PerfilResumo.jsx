...
export default function PerfilResumo({ dadosPessoais, statusValidacao, observacao, fotoUrl, onSalvo, permitirCorrecao }) {
  ...
  const handleSalvar = async () => {
    await onboardingCorrigirService.corrigirDadosPessoais(form);
    setEditando(false);
  ...
  return (
    <div className="card">
      ...
      <Avatar src={fotoUrl} sx={{ width: 100, height: 100, mb: 2 }}>
        {!fotoUrl && dadosPessoais.nomeCompleto?.charAt(0)}
      </Avatar>
      ...
      {editando ? (
        ...
        <TextField
          label="Data de nascimento"
          value={formatarDataBR(form.dataNascimento)}
          disabled
          fullWidth
          autoFocus
          margin="dense"
