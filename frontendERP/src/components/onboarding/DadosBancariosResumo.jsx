...
export default function DadosBancariosResumo({
  dadosBancarios,
  statusValidacao,
  observacao,
  onSalvo,
  ...
  const [form, setForm] = useState(dadosBancarios);
  ...
  if (!form) {
    return <p>Nenhum dado bancário encontrado.</p>;
  }
  ...
  const handleSalvar = async () => {
    await onboardingCorrigirService.corrigirDadosBancarios(form);
    setEditando(false);
  ...
  return (
    <div className="card">
      ...
      <TextField
        ...
        onChange={handleChange("bancoCodigo")}
      ...
      <TextField
        ...
        onChange={handleChange("bancoNome")}
        disabled={!editando}
        fullWidth
        margin="dense"
      />
      ...
      <TextField
        ...
        onChange={handleChange("digitoConta")}
        disabled={!editando}
        fullWidth
        margin="dense"
      />
